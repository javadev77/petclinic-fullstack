...
public class JdbcOwnerRepositoryImpl implements OwnerRepository {
    ...
    public Page<Owner> findPageByLastName(String lastName, Pageable pageable) {
        ...
        List<Owner> owners = this.namedParameterJdbcTemplate.query(
            "SELECT id, first_name, last_name, address, city, telephone FROM owners WHERE last_name LIKE :lastName LIMIT :size OFFSET :offset",
            params,
            BeanPropertyRowMapper.newInstance(Owner.class)
        );
        loadOwnersPetsAndVisits(owners);
    ...
    public Page<Owner> findPage(Pageable pageable) {
        ...
        params.put("size", pageable.getPageSize());
        List<Owner> owners = this.namedParameterJdbcTemplate.query(
            "SELECT id, first_name, last_name, address, city, telephone FROM owners LIMIT :size OFFSET :offset",
            params,
            BeanPropertyRowMapper.newInstance(Owner.class)
        );
        loadOwnersPetsAndVisits(owners);
