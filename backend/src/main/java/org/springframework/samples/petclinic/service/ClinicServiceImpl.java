...
public class ClinicServiceImpl implements ClinicService {
    ...
    @Override
    @Transactional(readOnly = true)
    public Page<Owner> findOwners(Pageable pageable) {
    ...
    @Override
    public Page<Owner> findOwnersPage(int page, int size, String lastName) {
        Pageable pageable = PageRequest.of(page, size);

        if (lastName != null && !lastName.isBlank()) {
            return ownerRepository.findPageByLastName(lastName, pageable);
        } else {
            return ownerRepository.findPage(pageable);
        }
    }
